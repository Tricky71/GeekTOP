...
// Букву О в логотипе заключаем в <span>
	$('.logo').each(function() {
		var ths = $(this);
		ths.html(ths.html().replace('O', '<span>O</span>'));
	});

//Появление поисковой строки при нажатии на 'Поиск'
// Курсор активен в поле поиска при открытии
	$('.search__button').click(function() {
		$('.search__field').stop().slideToggle();
		$('.search__field input[type=text]').focus();
	});

//Закрытие поисковой строки при нажатии на Esc
...
//Закрытие поисковой строки при клике в любом месте
	...
	$('.top-line__menu-button').click(function() {
    $('.top-line__menu').stop().slideToggle();
	});

});

// Подключение Read Progress (Prognroll)
$("body").prognroll({
	height: 3,
	color: "#ec1c1c",
	custom: false
...
// Добавление активного пункта в главное меню
